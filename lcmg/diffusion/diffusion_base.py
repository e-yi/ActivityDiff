...
class ModelPredType(str, enum.Enum):  # after py3.11, could be replaced with enum.StrEnum
    """
...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps, nu=1):
    """
    ...
    if schedule_name == "linear":
        ...
        return betas_for_alpha_bar(
            ...
            lambda t: math.cos((t ** nu + 0.008) / 1.008 * math.pi / 2) ** 2,
        )
    else:
